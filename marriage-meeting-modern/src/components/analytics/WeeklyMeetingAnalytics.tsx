...
export const WeeklyMeetingAnalytics: React.FC = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-100">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading weekly meeting analytics...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      >
        <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-2">Weekly Meeting Analytics</h1>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 mb-6 sm:mb-8">
        ...
        >
          <Card className="p-3 sm:p-4 lg:p-6 text-center bg-white shadow-sm">
            <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-slate-100 rounded-full flex items-center justify-center mx-auto mb-2 sm:mb-3">
              <Calendar className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-slate-600" />
            </div>
            <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">{metrics.totalMeetings}</h3>
            <p className="text-xs sm:text-sm text-gray-600">Total Meetings</p>
        ...
        >
          <Card className="p-3 sm:p-4 lg:p-6 text-center bg-white shadow-sm">
            <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-slate-100 rounded-full flex items-center justify-center mx-auto mb-2 sm:mb-3">
              <Target className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-slate-600" />
            </div>
            <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">{metrics.completionRate}%</h3>
            <p className="text-xs sm:text-sm text-gray-600">Completion Rate</p>
            <p className="text-xs text-gray-500 mt-1">Sections filled</p>
          </Card>
        </motion.div>
        ...
        >
          <Card className="p-3 sm:p-4 lg:p-6 text-center bg-white shadow-sm">
            <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-slate-100 rounded-full flex items-center justify-center mx-auto mb-2 sm:mb-3">
              <TrendingUp className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-slate-600" />
            </div>
            <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">{metrics.consistencyScore}%</h3>
        ...
        >
          <Card className="p-3 sm:p-4 lg:p-6 text-center bg-white shadow-sm">
            <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-slate-100 rounded-full flex items-center justify-center mx-auto mb-2 sm:mb-3">
              <Activity className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-slate-600" />
            </div>
            <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900">{metrics.mostActiveDay}</h3>
            <p className="text-xs sm:text-sm text-gray-600">Most Active Day</p>
            <p className="text-xs text-gray-500 mt-1">Schedule activity</p>
          </Card>
        </motion.div>
      </div>
          ...
          <Card className="p-4 sm:p-6 bg-white shadow-sm">
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="flex justify-between items-center">
                <span className="text-xs sm:text-sm text-gray-600">Goal Achievement</span>
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs sm:text-sm font-medium text-gray-900">{metrics.goalAchievement}%</span>
                </div>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-xs sm:text-sm text-gray-600">Prayer Consistency</span>
                <div className="flex items-center gap-2">
                  <div className="w-16 sm:w-24 bg-gray-200 rounded-full h-2">
                    <div 
                      className="bg-slate-600 h-2 rounded-full transition-all duration-300"
                  ...
                  <span className="text-xs sm:text-sm font-medium text-gray-900">{metrics.prayerConsistency}%</span>
                </div>
              </div>
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs sm:text-sm font-medium text-gray-900">{metrics.taskCompletion}%</span>
                </div>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-xs sm:text-sm text-gray-600">Grocery Planning</span>
                <div className="flex items-center gap-2">
                  <div className="w-16 sm:w-24 bg-gray-200 rounded-full h-2">
                    <div 
                      className="bg-slate-600 h-2 rounded-full transition-all duration-300"
                  ...
                  <span className="text-xs sm:text-sm font-medium text-gray-900">{metrics.groceryPlanning}%</span>
                </div>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-xs sm:text-sm text-gray-600">Spiritual Growth</span>
                <div className="flex items-center gap-2">
                  <div className="w-16 sm:w-24 bg-gray-200 rounded-full h-2">
                    <div 
                      className="bg-slate-600 h-2 rounded-full transition-all duration-300"
                  ...
                  <span className="text-xs sm:text-sm font-medium text-gray-900">{metrics.spiritualGrowth}%</span>
                </div>
              </div>
            </div>
          </Card>
            ...
            <div className="space-y-2 sm:space-y-3">
              {trendData.map((data, index) => (
                <div key={index} className="flex justify-between items-center py-2 border-b border-gray-100 last:border-b-0">
                  <span className="text-xs sm:text-sm font-medium text-gray-900">{data.month}</span>
