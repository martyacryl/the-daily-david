...
export const EnhancedWeeklyReview: React.FC<EnhancedWeeklyReviewProps> = ({ 
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-slate-100 pt-16 sm:pt-20 flex items-center justify-center">
  ...
  return (
    <div className={`min-h-screen bg-slate-100 pt-16 sm:pt-20 ${className}`}>
