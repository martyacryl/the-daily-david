    ...
    <div className={className}>
      ...
      <AnimatePresence>
        {isExpanded && (
          ...
          >
            <Card className="p-4 sm:p-6 bg-white shadow-lg border border-slate-200">
              {/* Header */}
              ...
              {/* Week Grid */}
              <div className="grid grid-cols-5 sm:grid-cols-7 gap-2 sm:gap-3 mb-4">
                {weekDates.map((day, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className={`
                        relative bg-white rounded-lg border-2 p-2 sm:p-3 cursor-pointer transition-all duration-200
                        ${isToday 
                    ...
                    >
                      ...
                      <div className="text-center mb-2">
                        ...
                        <div className={`text-xs ${
                          isToday ? 'text-slate-700 font-semibold' : 'text-gray-500'
                        }`}>
                      ...
                      <div className="space-y-1">
                        {scheduleItems.length > 0 ? (
                          scheduleItems.map((item, itemIndex) => (
                            <div
                              key={itemIndex}
                              className="text-xs text-gray-700 bg-slate-100 rounded px-1 py-0.5 truncate"
                              title={item}
                            >
                              {item}
                            </div>
