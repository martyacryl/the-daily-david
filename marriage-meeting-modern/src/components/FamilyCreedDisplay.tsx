...
export const FamilyCreedDisplay: React.FC<FamilyCreedDisplayProps> = ({ className = '' }) => {
  ...
  return (
    <motion.div
      ...
      className={className}
    >
      <Card className="p-4 bg-gradient-to-br from-slate-200 to-purple-200 dark:from-slate-700 dark:to-purple-800 border-slate-400 dark:border-slate-600 backdrop-blur-sm">
