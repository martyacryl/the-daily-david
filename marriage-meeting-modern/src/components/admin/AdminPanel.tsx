...
export function AdminPanel({ dbManager }: AdminPanelProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-100 to-green-50 dark:from-gray-900 dark:to-gray-800">
      <div className="container mx-auto px-4 pt-14 pb-8 max-w-6xl">
        ...
        {showPasswordChange && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <motion.div
              ...
              className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-md mx-4 border border-gray-200 dark:border-gray-600"
            >
