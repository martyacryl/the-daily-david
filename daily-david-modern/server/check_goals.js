...
async function checkGoals() {
  try {
    const result = await pool.query('SELECT data_content FROM daily_david_entries WHERE user_id = $1 ORDER BY date_key DESC LIMIT 1;', ['5d893914-0343-4373-ab16-ae835f9baf33']);
