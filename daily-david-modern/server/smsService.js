...
// Inspirational messages and Bible verses for Daily David
...
class SMSService {
  ...
  async sendOptOutConfirmation(phoneNumber) {
    const message = `You've been unsubscribed from Daily David SMS notifications. You can re-enable them anytime in your app settings.\n\nThank you for being part of the Daily David community! 🙏`;
