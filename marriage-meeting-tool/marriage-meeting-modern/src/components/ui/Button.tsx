...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'default', size = 'md', loading, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      default: 'bg-gradient-to-r from-slate-500 to-purple-600 text-white hover:from-slate-600 hover:to-purple-700 focus:ring-purple-500 shadow-md hover:shadow-lg',
